...
def register_all_visdrone(root):
    SPILTS = {
        "visdrone_train": (
            "VisDrone2019-DET-train_dense/images",
            "VisDrone2019-DET-train_dense/annotations/train.json"
        ),
        "visdrone_val": (
            "VisDrone2019-DET-val_dense/images",
            "VisDrone2019-DET-val_dense/annotations/val.json"
        ),
        ...
        "visdroneplussr_train": (
            "VisDronePlusSR/train",
            "VisDronePlusSR/annotations/train.json"
        ),
        # "visdronepp_train": (
        #     "VisDronePP/train",
