...
if __name__ == '__main__':
    ...
    xml_path = '/home/huawei/JiachenWei_workdir/glsan/datasets/VisDrone2019-DET-train_dense/Annotations_XML/'
    xml_file = glob.glob(os.path.join(xml_path, '*.xml'))
    # convert(xml_file, '/data/VisDrone2019-DET-val_dense/annotations/val.json')
    convert(xml_file, '/home/huawei/JiachenWei_workdir/glsan/datasets/VisDrone2019-DET-train_dense/annotations/train.json')
