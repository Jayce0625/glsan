...
# root_dir = "/data/VisDrone2019-DET-val_dense/"
root_dir = "/home/huawei/JiachenWei_workdir/glsan/datasets/VisDrone2019-DET-train_dense/"
...
for filename in tqdm(os.listdir(annotations_dir)):
    ...
    with open(xml_name, 'w') as fout:
        ...
        for line in fin.readlines():
            line = line.split(',')
            if not (0 < int(line[5]) < 11): continue
            fout.write('\t' + '<object>' + '\n')
