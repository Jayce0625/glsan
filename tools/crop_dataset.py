...
_root = '/home/huawei/JiachenWei_workdir/glsan/datasets/'
...
if __name__ == "__main__":
    ...
    # print(dataset_len('/home/huawei/JiachenWei_workdir/datasets/VisDrone2019-DET-val_dense/'))
    args = default_argument_parser().parse_args()
    print("Command Line Args:", args)
    cfg = setup(args)
    crop_dataset(cfg, 'visdrone_train', 'VisDronePlus', cluster_num=4, categories=visdrone_categories,
                 crop_size=0)
    # crop_dataset(cfg, 'visdroneplus_train', 'VisDronePP', cluster_num=4, categories=visdrone_categories,
    #              crop_size=0)
